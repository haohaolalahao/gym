...
def submit(
    ...
    # NOTE check courts
    try:
        status_1 = check_court_status(day=day, court=court_1, book_time_1=book_time_1_1, book_time_2=book_time_1_2, print_info=True)
        if status_1 != 1:
           return 0
        status_2 = check_court_status(day=day, court=court_2, book_time_1=book_time_2_1, book_time_2=book_time_2_2, print_info=True)
        if status_2 != 1:
           return 0
    except:
        print('check field')
