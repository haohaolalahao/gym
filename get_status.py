...
def check_bm_status(require_data="tomorrow"):
            ...
            for time in times:
                for court in courts:
                    ...
                    if bm_status_data[status_key] == 0:
                        rows[i].append("[bold italic green]True[/bold italic green]")
                        ...
                        rows[i].append(":loudly_crying_face:")
                i += 1
            table = Table(title=require_data + " Badminton Court", header_style="bold blue")
    ...
    #         table = Table(title=require_data + " Price", header_style="bold blue")
...
if __name__ == "__main__":
    check_bm_status(require_data="2022-05-22")
    # check_bm_status(require_data="tomorrow")
    # check_bm_status(require_data="today")
